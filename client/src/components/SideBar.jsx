...
>
  ...
  <div className="flex justify-between items-center">
    <img
      src={assets.logo}
      alt="logo"
      className="max-w-15 cursor-pointer rounded-3xl"
    />
  ...
  <div className='flex flex-col'>
    {userDummyData.map((user,index)=>(
      ...
      key={index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser ?._id && 'bg-[#282142]/50'}`}>
