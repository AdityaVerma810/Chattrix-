  ...
  return selectedUser ?(
	<div className='h-full overflow-scroll relative backdrop-blur-lg'>
	  ...
	  <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
		...
		<p className='flex-1 text-lg text-white flex items-center gap-2'>Martin Jonson
...
<div ref={scrollEnd}></div>
	...
	{/*---Bottom area*/}
	<div className="sticky bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-black/40 backdrop-blur-md">

		<div className='flex-1 flex items-center bg-blue-700/70 px-3 rounded-full'>
			...
			<label htmlFor='image'>
				<img src={assets.gallery_icon} alt='' className='w-5 bg-amber-300 mr-2 cursor-pointer'/>
	...
	<div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
		<img src={assets.logo} alt='' className='mx-md:hidden w-20 rounded-4xl' />
		<p className='text-lg font-medium text-white' >"Talk, share, and care — anytime, anywhere"</p>
	</div>
  )
}
